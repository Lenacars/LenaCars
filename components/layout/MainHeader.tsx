      ...
      <div className="bg-[#6A3C96] text-white py-3 px-4">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <Link href="/iletisim" aria-label="Adres" className="hover:text-gray-200">
              📍
            </Link>
            <Link href="/iletisim" aria-label="E-posta" className="hover:text-gray-200">
              ✉️
            </Link>
            <Link href="/iletisim" aria-label="Telefon" className="hover:text-gray-200">
              📞
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-3">
            <Link href="https://facebook.com" target="_blank" aria-label="Facebook" className="hover:text-gray-200">📘</Link>
            <Link href="https://instagram.com" target="_blank" aria-label="Instagram" className="hover:text-gray-200">📸</Link>
            <Link href="https://linkedin.com" target="_blank" aria-label="LinkedIn" className="hover:text-gray-200">💼</Link>
            <Link href="https://youtube.com" target="_blank" aria-label="YouTube" className="hover:text-gray-200">📺</Link>
          </div>
        </div>
      </div>
