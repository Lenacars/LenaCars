...
import { useRouter } from 'next/navigation'; // <--- 1. useRouter import edildi
...
export default function MainHeader() {
  ...
  const router = useRouter(); // <--- 2. router instance'ı oluşturuldu
  ...
  // <--- 3. Arama işlemini yönetecek fonksiyon
  const handleSearch = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault(); // Formun varsayılan gönderme işlemini engelle
    if (searchTerm.trim()) { // Arama terimi boş değilse
    ...
    <header>
      ...
      <div className="bg-[#6A3C96] text-white py-3 px-4">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-3">
            ...
            <Link href="https://youtube.com" target="_blank" className="hover:text-gray-200" aria-label="YouTube"> {/* Link güncellenmeli, youtube.com olmalı */}
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
      ...
      <div className="bg-white py-4 px-4 shadow-sm">
        <div className="container mx-auto flex justify-between items-center">
          ...
          {/* <--- 4. Masaüstü arama kutusu form ile sarmalandı ve onSubmit eklendi */}
          <form onSubmit={handleSearch} className="hidden md:block flex-grow mx-4 max-w-md">
            <div className="relative">
              ...
              />
              <button
                type="submit" // <--- Buton tipi "submit" olarak değiştirildi
      ...
      {/* Mobil Arama */}
      {/* <--- 5. Mobil arama kutusu form ile sarmalandı ve onSubmit eklendi */}
      {isMobile && (
