            ...
            <TabsContent value="register">
              <form onSubmit={handleRegister} className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  >
                    <span>
                      <a href="/kullanim-kosullari" className="text-purple-700 hover:text-purple-800">Kullanım Koşulları</a>
                      {' '}ve{' '}
                      <a href="/gizlilik-politikasi" className="text-purple-700 hover:text-purple-800">Gizlilik Politikası</a>
                      'nı kabul ediyorum
                    </span>
                  </label>
                </div>
