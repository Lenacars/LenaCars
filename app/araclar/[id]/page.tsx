...
  Home, Warehouse, QrCode, Car // "Car" ikonu buraya eklendi
} from "lucide-react";
...
                </div>
                
                {/* === GÜNCELLENMİŞ BUTON ALANI BAŞLANGICI === */}
                <div className="mt-auto space-y-3 pt-4">
                    {/* 1. Garaja Ekle Butonu (En Üstte) */}
                    <button
                        onClick={handleVehicleToggleGarage}
                        disabled={isVehicleAddingToGarage}
                        className={`w-full flex items-center justify-center px-6 py-2.5 border rounded-lg shadow-sm text-sm font-semibold transition-all duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-[#6A3C96] ${
...
                                    : "text-white bg-[#6A3C96] hover:bg-[#58307d] border-transparent"
                        }`}
                    >
...
                    {/* 2. Garaja Git Butonu (Ortada ve Mor) */}
                    <Link
                        href="/garaj"
...
                    {/* 3. Tüm Araçları Gör Butonu (En Altta, Mor ve Yeni İkon) */}
                    <Link
                        href="/araclar"
                        className="w-full flex items-center justify-center px-6 py-2.5 border border-transparent rounded-lg shadow-sm text-sm font-semibold text-white bg-[#6A3C96] hover:bg-[#58307d] focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-[#6A3C96] transition-all duration-150 ease-in-out"
                    >
                        <Car size={18} className="mr-2"/> {/* İkon Car olarak değiştirildi */}
                        Tüm Araçları Gör
                    </Link>
                </div>
                {/* === GÜNCELLENMİŞ BUTON ALANI SONU === */}
            </div>
            </div>
        </div>
