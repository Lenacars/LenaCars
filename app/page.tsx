...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      <header className="bg-white p-4 border-b">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="flex space-x-8">
            <Link href="#" className="font-medium">Kurumsal</Link>
            <Link href="#" className="font-medium">Kiralama</Link>
            <Link href="#" className="font-medium">İletişim</Link>
          </nav>
        </div>
      </header>
      ...
      {/* Mevcut içerik - burada önceki içeriğiniz devam edecek */}
